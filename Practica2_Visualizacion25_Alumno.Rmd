...
grafico2
grafico2+scale_color_binned()
grafico3 <- grafico2+ggtitle("Gráfico de dispersión temperatura mínima (MinTemp) frente a máxima (MaxTemp)")
grafico3
...
grafico3
grafico3+labs(title ="Gráfico de dispersión temperatura (Temp9am) frente a Presión (Pressure9am)", subtitle="Que bonita grafica", x="Representa Temperatura", y = "Representa Presión", caption = "Esta leyenda lo confirma")
...
#Se nota la dispersión de los valores mucho más claramente
...
ggplot(data=DatosEjer4, aes(x=Fecha, y=Ventas, colour=Fabricante)) +
  geom_point()

#SÍ, se ve cómo ha evolucionado y cómo Microsoft ha tenido mayores ventas
...
ggplot(data=DatosEjer4, aes(x=Fecha, y=Ventas, colour=Fabricante)) +
  geom_line(aes(linetype=Fabricante))+
  geom_point()+
  ggtitle("Ventas mensuales de diferentes compañías tecnológicas")
...
ggplot(data=ice.river.df,aes(x=time))+geom_line(aes(y=flow.vat), color='red')+geom_line(aes(y=flow.jok), color='blue')+
  labs(title='En este titulo de muestra vatdalsa y jokulsa', x="Time(years)", y="eL FLOW", caption="Esta es la leyenda")
